const appName = 'Lumen'
const appCacheName = 'Lumen-0.6.3';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.5.0-b.1/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
