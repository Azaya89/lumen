...
async function loadApplication(cell_id, path) {
  ...
  const packages = ['https://cdn.holoviz.org/panel/1.5.0-b.1/dist/wheels/bokeh-3.5.0-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.5.0-b.1/dist/wheels/panel-1.5.0b1-py3-none-any.whl', 'lumen==0.6.3', 'requests', 'pandas', 'pyodide-http', 'holoviews>=1.15.1'];
  if (path != null) {
